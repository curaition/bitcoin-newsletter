            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <div className="prose prose-sm max-w-none">
                  <div className="text-sm whitespace-pre-wrap bg-muted/50 p-4 rounded-md max-h-96 overflow-y-auto">
                    {newsletter.content.substring(0, 2000)}
                    {newsletter.content.length > 2000 && '...'}
                  </div>
                </div>
              </div>
            </CardContent>
