...
def test_newsletter_generation():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"✅ Newsletter generation task started successfully!")
...
def monitor_task_progress(task_id, max_wait_minutes=10):
    ...
    progress_url = f"https://bitcoin-newsletter-api.onrender.com/admin/tasks/{task_id}/progress"
    ...
    while time.time() - start_time < max_wait_seconds:
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"📊 Status: {status} | Step: {current_step} | Progress: {progress_pct}%")
                ...
                if status in ["completed", "success"]:
                    ...
                    if "Event loop is closed" in error_msg:
                        ...
                        print("ℹ️  Task failed for other reasons (not event loop related)")
                        return False
